...
cmake -G "Visual Studio 16 2019" -A Win32 %~dp0\..\.. -DPROJECT_ATFRAME_BUILD_THIRD_PARTY=ON -DPROJECT_ATFRAME_TARGET_CPU_ABI=x86 -DPROJECT_ATFRAME_BUILD_THIRD_PARTY_BUSYBOX_MODE=ON -DCMAKE_INSTALL_PREFIX=%INSTALL_PREFIX%
