...
function (ATPBExpandListForCommandLineToFile)
    unset (ATPBExpandListForCommandLineToFile_OUTPUT)
    unset (ATPBExpandListForCommandLineToFile_LINE)
    foreach(ARG IN LISTS ARGN)
        if (NOT ATPBExpandListForCommandLineToFile_OUTPUT)
            set (ATPBExpandListForCommandLineToFile_OUTPUT "${ARG}")
        else ()
            string(REPLACE "\\" "\\\\" ATPBExpandListForCommandLine_OUT_VAR ${ARG})
            string(REPLACE "\"" "\\\"" ATPBExpandListForCommandLine_OUT_VAR ${ATPBExpandListForCommandLine_OUT_VAR})
            if (ATPBExpandListForCommandLineToFile_LINE)
                set (ATPBExpandListForCommandLineToFile_LINE "${ATPBExpandListForCommandLineToFile_LINE} \"${ATPBExpandListForCommandLine_OUT_VAR}\"")
            else ()
                set (ATPBExpandListForCommandLineToFile_LINE "\"${ATPBExpandListForCommandLine_OUT_VAR}\"")
            endif ()
            unset (ATPBExpandListForCommandLine_OUT_VAR)
        endif ()
    endforeach()

    if (ATPBExpandListForCommandLineToFile_OUTPUT)
        file(APPEND "${ATPBExpandListForCommandLineToFile_OUTPUT}" "${ATPBExpandListForCommandLineToFile_LINE}${ATFRAME_THIRD_PARTY_BUILDTOOLS_EOL}")
    endif ()
    unset (ATPBExpandListForCommandLineToFile_OUTPUT)
    unset (ATPBExpandListForCommandLineToFile_LINE)
endfunction()
