...
function(ATPBTargetBuildThirdPartyByConfigure)
    ...
    if(ATFRAME_THIRD_PARTY_ENV_PATH)
        if (CMAKE_HOST_UNIX OR MSYS)
            unset(ATFRAME_THIRD_PARTY_ENV_PATH_CMD)
            string(REPLACE ";" ":" ATFRAME_THIRD_PARTY_ENV_PATH_CMD "${ATFRAME_THIRD_PARTY_ENV_PATH}")
            file(WRITE "${ATFRAME_THIRD_PARTY_BUILD_WORK_DIR}/configure-load-env.sh" "export PATH=\"${ATFRAME_THIRD_PARTY_ENV_PATH_CMD}:\$PATH\"")
            set (ATFRAME_THIRD_PARTY_CMD_PREIFX "source" "${ATFRAME_THIRD_PARTY_BUILD_WORK_DIR}/configure-load-env.sh")
            ATPBMakeExecutable("${ATFRAME_THIRD_PARTY_BUILD_WORK_DIR}/configure-load-env.sh")
            unset(ATFRAME_THIRD_PARTY_ENV_PATH_CMD)
        else ()
            file(WRITE "${ATFRAME_THIRD_PARTY_BUILD_WORK_DIR}/configure-load-env.bat" "set PATH=\"${ATFRAME_THIRD_PARTY_ENV_PATH}:\$PATH\"")
            set (ATFRAME_THIRD_PARTY_CMD_PREIFX "${ATFRAME_THIRD_PARTY_BUILD_WORK_DIR}/configure-load-env.bat")
            ATPBMakeExecutable("${ATFRAME_THIRD_PARTY_BUILD_WORK_DIR}/configure-load-env.bat")
        endif ()
    else ()
        set (ATFRAME_THIRD_PARTY_CMD_PREIFX "echo" "\"No Additional PATH\"")
    endif()
